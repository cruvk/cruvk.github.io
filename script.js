const translations = {
    ru: {
        ...
        trustP1: "Гарант — это физическое лицо, компания или организация, которые официально подтверждают выполнение обязательств одной стороны перед другой. Проведено более 750+ успешных сделок.",
        stat1: "Сделок",
        stat2: "Выплат",
    ...
    en: {
        ...
        trustP1: "A guarantor is an individual or organization that officially confirms the fulfillment of obligations. 750+ successful deals completed.",
        stat1: "Deals",
        stat2: "Payouts",
